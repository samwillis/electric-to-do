...
export const ItemsScalarFieldEnumSchema = z.enum(['id','title','done','added']);
...
export const ItemsWhereInputSchema: z.ZodType<Prisma.ItemsWhereInput> = z.object({
  ...
  added: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
}).strict();
...
export const ItemsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ItemsScalarWhereWithAggregatesInput> = z.object({
  ...
  added: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
}).strict();
...
export const ItemsUpdateInputSchema: z.ZodType<Prisma.ItemsUpdateInput> = z.object({
  ...
  added: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();
